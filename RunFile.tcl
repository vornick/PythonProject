...
# MCEConC16 made on Jan 19 2016 19:28
#################################################
...
# ixNet objects needs to be added in the list before they are configured!
$MAC_VLAN_2 childrenList.appendItem -object $IP_1
...
# ixNet objects needs to be added in the list before they are configured!
$MAC_VLAN_1 childrenList.appendItem -object $IP_2
...
$testController setResultDir "C:\\5\\Result\\TCP\\CGW_MCE\\ConcurrentConnections\\100\\1518"
